...
public final class EntryPointDefinitionContainer extends RequestDefinitionContainer/*<EntryPointDefinition>*/ {
    
    public EntryPointDefinitionContainer(final RuleFileLoader ruleFileLoader) {
        super(ruleFileLoader, false); // false since EntryPoint-Definitions should (for security reasons) *not* utilize non-standard permutation variants
    }
    ...
    protected RequestDefinition createRequestDefinition(final boolean enabled, final String identification, final String description, final CustomRequestMatcher customRequestMatcher) {
        return new EntryPointDefinition(enabled, identification, description, customRequestMatcher);
    }
