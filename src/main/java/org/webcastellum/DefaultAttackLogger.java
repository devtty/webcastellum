...
public final class DefaultAttackLogger implements AttackLogger {
    ...
    public static final String PARAM_DIRECTORY = "DefaultAttackLoggerDirectory"; public static final String LEGACY_PARAM_DIRECTORY = "AttackLogDirectory";
    public static final String PARAM_COUNT = "DefaultAttackLoggerPreAndPostCount"; public static final String LEGACY_PARAM_COUNT = "PreAndPostAttackLogCount";
    ...
    public void init(final String application, final boolean isProductionMode, final boolean logVerboseForDevelopmentMode) {
        ...
        if (directory != null && directory.trim().length() != 0) {
            ...
            try {
                ...
                fileHandlerPointerForSecurityLogging = new FileHandler(directory+"/WebCastellum-Security"+applicationAdjusted+"-%g-%u.log", 1024*1024*5, 20, false);
  ...
  private void decreasePostAttackLogCounter() {
    ...
    public void log(boolean warning, String message) throws AttackLoggingException {
        ...
        record.setSourceClassName("WebCastellum");
