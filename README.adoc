:icons: font
:ci: https://github.com/devtty/webcastellum/actions/workflows/build.yaml
...
image:https://github.com/devtty/webcastellum/actions/workflows/build.yaml/badge.svg["Build Status", link={ci}]
